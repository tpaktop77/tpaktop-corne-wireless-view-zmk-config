...
- [x] 4.2 Собрать обе штатные конфигурации nice!view, включая Studio snippet на `corne_left`, и записать успешные GitHub Actions checks либо локальные результаты в test matrix.
- [x] 4.3 Создать отдельный PR с причиной регрессии, ссылками на OpenSpec, результатами сборки и списком оставшихся аппаратных thumb-тестов; не архивировать change до подтверждения на клавиатуре.
